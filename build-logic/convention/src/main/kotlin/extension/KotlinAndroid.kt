...
internal fun Project.configureKotlinAndroid(
    commonExtension: CommonExtensionAndroid
) {
    ...
    dependencies {
        ...
        add("testImplementation", libs.findLibrary("test-ext-junit").get())
        add("androidTestImplementation", libs.findLibrary("test-ext-junit").get())
        add("androidTestImplementation", libs.findLibrary("test-espresso-core").get())
    }
}
